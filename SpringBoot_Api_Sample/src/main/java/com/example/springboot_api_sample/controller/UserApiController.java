...
import com.example.springboot_api_sample.exceptionhandle.ApiValidationError;
import com.example.springboot_api_sample.responseobject.ApiError;
...
public class UserApiController {
    ...
    public ResponseEntity<?> findById(@Valid @PathVariable("id") int id) {
        ...
        return optional.isPresent() ?
                ResponseEntity.status(HttpStatus.OK).body(optional)
                : ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ApiError(HttpStatus.NOT_FOUND));
    }
